<template>
  <main id="tapestry" ref="app" :style="{backgroundColor: dragoverBackgroundColor}">
    ...
    <div class="white-box" v-if="!empty || tapestryGenerated"> 
      <span class="strength-of-relevancy">Strength of relevancy connections</span> <br>
      A default connection between nodes is represented in <span class="navy-blue">navy blue</span><br>
      The color of the connection represents the <span class="navy-blue">strength of the relevancy</span> between grandchild nodes. It represents a correlation number - note that this number is generated by ChatGPT-3.5 after comparing the similarity of texts between two nodes.
    <br>
  ...
  <div>
    ...
    <template>
      <div class="upload-texts"
        ...
        <div class="upload-a-pdf-text-container">
          ...
          <div class="column">
            <span v-if="dragoverBackgroundColorInitial" class="upload-large-text">Upload a PDF</span>
            <div class="row">
              <span v-if="dragoverBackgroundColorInitial" class="upload-small-text">Drag and drop or</span>   
              <div>
                <input
                    ref="fileInput"
    ...
    <div class="container">
      <div v-if="empty && !threeButtonClicked" class="large-main-text">How do you want to generate your Tapestry?</div>
      <br>
      <div class="button-container" v-if="showLearningObjectivesButton || empty && (showUploadPDF || showWritePrompt || showCreateYourself)">
        ...
        <div class="button-boxes">
          <div v-if="!showLearningObjectivesButton" class="dotted-ml-box">
          ...
          <button class="learning-outcomes-button" @click="writeLOPrompt" v-if="empty && showLearningObjectivesButton">
            <img :src="LearningObjectives" style="margin-bottom: 10px;"/><br><span class="large-white-text">From Learning Objectives</span><br>
          ...
          <button class="write-a-prompt-second-button" @click="writePrompt" v-if="empty && showFromPromptButton">
            <img :src="Prompt" style="margin-bottom: 10px;"/><br><span class="large-white-text">From a Prompt</span><br>
...
import UploadPDFGray from "@/assets/upload_pdf_gray.png"
...
import UploadPDFVector from "@/assets/Vector (1).svg"
