...
@app.route('/wordpress/tapestry/eml/submit-user-input', methods=['POST'])
...
def handle_form_submission():
    ...
    # This is to calculate angles later potentially to make sure they don't overlap with the "parent" aka child node
    first_layer_coord_arr = []
    ...
    for text in splitted_text:
        ...
        first_layer_coord_arr.append((x, y))
        ...
        time.sleep(0.2) #Added a short 200ms delay
    ...
    return jsonify({'message': 'Nodes generated successfully.'})
