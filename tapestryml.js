...
export async function tapestryGeneration(userInput) {
  ...
  const node_generating_api_endpoint = "https://tapestry.emlx.ca/wp/wp-json/tapestry-tool/v1/tapestries/24/nodes";
  // Tapestry API Endpoint - Link Generation 
  const link_generating_api_endpoint = "https://tapestry.emlx.ca/wp/wp-json/tapestry-tool/v1/tapestries/24/links";
  // Tapestry API Endpoint
  const tapestry_api_endpoint = "https://tapestry.emlx.ca/wp/wp-json/tapestry-tool/v1/tapestries/24";
